...
public class GameWindow extends JFrame implements ActionListener
{
    ...
    String word[] =
    {
        "JAPAN", "QATAR", "SYRIA", "MONGOLIA", "BHARAIN", "INDIA", "PAKISTAN", "AUSTRALIA", "AFGHANISTAN", "CHINA"
    };
    ...
    @Override
    public void actionPerformed(ActionEvent ae) throws StringIndexOutOfBoundsException
    {
       ...
       // System.out.println(letter);
        ...
        if (count == len)
        {
            JOptionPane.showMessageDialog(this, "Congrates You Guessed the Word correctly");
        ...
        if (chance > 5)
        {
            JOptionPane.showMessageDialog(this, "Sorry You Lost Your Chnaces");
            int n = JOptionPane.showConfirmDialog(this, "Do you want to play again?", "Restart Game", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
